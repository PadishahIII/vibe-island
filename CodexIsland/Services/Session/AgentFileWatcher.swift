...
private let logger = Logger(subsystem: "com.vibeisland", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.vibeisland.agentfilewatcher", qos: .userInitiated)
